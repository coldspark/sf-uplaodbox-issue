...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<br />
	<script src='<%= Page.ResolveClientUrl("~/Scripts/ej/i18n/ej.culture.en-GB.min.js")%>' type="text/javascript"></script>
	<script src='<%= Page.ResolveClientUrl("~/Scripts/ej/l10n/ej.localetexts.en-GB.min.js")%>' type="text/javascript"></script>
	<div id="ControlRegion">
		<div class="frame">
			<div class="control">
				<div class="posupload">
					<ej:UploadBox ID="Upload1" SaveUrl="saveFiles.ashx" RemoveUrl="removeFiles.ashx" DropAreaText="ABC"
						AllowDragAndDrop="true"
						AutoUpload="true"
						AsyncUpload="true" MultipleFilesSelection="true" runat="server">
						<UploadBoxButtonText Browse="Choose a file" />
					</ej:UploadBox>
